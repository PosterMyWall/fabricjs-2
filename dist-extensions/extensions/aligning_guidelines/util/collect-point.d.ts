...
export declare function collectVerticalPoint(this: AligningGuidelines, props: CollectPointProps): LineProps[];
export declare function collectHorizontalPoint(this: AligningGuidelines, props: CollectPointProps): LineProps[];
export {};
